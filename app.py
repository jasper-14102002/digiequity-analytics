...
with tab5:
    ...
    available_cols = [c for c in display_cols if c in df_topsis.columns]
    df_display     = df_topsis[available_cols].copy().sort_values(rank_col)
    ...
    india_topsis = df_topsis[df_topsis['country_name'] == 'India']
