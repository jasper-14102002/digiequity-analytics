...
with tab5:
    ...
    # Fix duplicate columns in topsis CSV before use
    df_topsis_clean = df_topsis.loc[:, ~df_topsis.columns.duplicated()]
    ...
    df_display     = df_topsis_clean[available_cols].copy().sort_values(rank_col)
    ...
    def highlight_india(row):
        ...
        elif row[rank_col] >= len(df_topsis_clean) - 10:
